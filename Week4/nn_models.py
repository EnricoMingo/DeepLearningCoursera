...
def predict(X, y, parameters):
    ...
    # Forward propagation
    probas, caches = hf.L_model_forward(X, parameters)
...
def two_layer_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 3000, print_cost=False):
    ...
    for i in range(0, num_iterations):
        ...
        A1, cache1 = hf.linear_activation_forward(X, W1, b1, 'relu')
        A2, cache2 = hf.linear_activation_forward(A1, W2, b2, 'sigmoid')
    
        cost = hf.compute_cost(A2, Y)
        
        dA2 = - (np.divide(Y, A2) - np.divide(1 - Y, 1 - A2))
        
        dA1, dW2, db2 = hf.linear_activation_backward(dA2, cache2, 'sigmoid')
        dA0, dW1, db1 = hf.linear_activation_backward(dA1, cache1, 'relu')
